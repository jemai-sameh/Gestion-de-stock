...
public class Product extends Category{
	...
	/**
	 * Renvoie l'historique des quantites du produit
	...
	/**
	 * Definit les quantites des produits
	...
	/**
	 * vend une certaine quantite de produit un jour donnee, et met a jour l'historique des quantit�s en fonction
	 * @param quantity la quantite du produit vendue
	...
	/**
	 * Renvoie la quantite actuelle du produit en stock
	 * @return
	 */
	...
	/**
	 * Definit la quantite actuelle du produit.
	 * @param q
	 */
	...
	/**
	 * Renvoie la quantite du produit a la date d selon l'historique du produit
	 * @param d date
	 * @return
	 */
