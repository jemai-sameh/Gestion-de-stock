...
public class StructureManagerWindow extends Panel implements ActionListener, MouseListener {
	...
	Arbre arbre;
	int a=0;
	DefaultMutableTreeNode nodeToMove;	//utiliser pour le deplacement d'une categorie
	...
	public void mouseClicked(MouseEvent e) {
		if(arbre.arbre.getBounds().contains(e.getPoint())){
			//Si l'utilisateur a cliquer sur l'arbre on regarde si le noeud selectionner est une categorie ou un produit
			//et on active/desactive certains boutons en consequence
			DefaultMutableTreeNode selectedNode = arbre.getLastSelectedNode();
