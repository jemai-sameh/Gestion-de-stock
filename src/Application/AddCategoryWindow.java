	...
	public AddCategoryWindow(StructureManagerWindow manager, Category cat){
	    ...
	    public void actionPerformed(ActionEvent e) {
	        if(e.getSource() == okButton){
	                ...
	                if(name.length()==0){
	                        JOptionPane.showMessageDialog(this, "Erreur: le nom de la categorie ne peut pas etre vide.", "Erreur entree utilisateur",
	                        ...
	                        try{
	                                ...
	                                JOptionPane.showMessageDialog(this, "Erreur: le prix et la quantite doivent etre de type numerique.", "Erreur entr�e utilisateur",
	                                                                                        JOptionPane.ERROR_MESSAGE);
	                        }
	                }
	        }
